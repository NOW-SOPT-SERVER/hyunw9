package org.sopt.sopt.post.presentation;
...
import org.sopt.sopt.post.application.PostService;
...
public class PostController {
  ...
  public ResponseEntity<?> createArticle(
    ...
    return ResponseEntity.status(HttpStatus.CREATED)
        ...
        SuccessStatus.POST_WRITE_SUCCESS,postService.postArticle(memberId, postCreateRequest)
    ));
  }
  ...
  public ResponseEntity<?> getAllMemberPost(
    ...
    return ResponseEntity.status(HttpStatus.OK)
        .body(SuccessStatusResponse.of(
        SuccessStatus.POST_GET_SUCCESS,postService.getMemberAllArticle(memberId)
    ));
  }
  ...
  public ResponseEntity<?> getSpecificPost(
    ...
    return ResponseEntity.status(HttpStatus.OK)
        .body(SuccessStatusResponse.of(
        SuccessStatus.POST_GET_SUCCESS,postService.getSpecificPost(postId)
    ));
  }
}
